...
function CountrySelect() {
    return (React.createElement(Autocomplete_1["default"], { id: "country-select-demo", sx: { width: 300 }, options: countries, autoHighlight: true, getOptionLabel: function (option) { return option.label; }, renderOption: function (props, option) {
            ...
            return (React.createElement(Box_1["default"], __assign({ key: key, component: "li", sx: { '& > img': { mr: 2, flexShrink: 0 } } }, optionProps),
                ...
                option.label));
        }, renderInput: function (params) { return (React.createElement(TextField_1["default"], __assign({}, params, { label: "Choose a country", size: 'small' }))); } }));
}
